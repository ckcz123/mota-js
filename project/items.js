var items_296f5d02_12fd_4166_a7c1_b5e830c9ee3a = 
{
	...
	"useItemEffect": {
		...
		"centerFly": "core.playSound('centerFly.mp3');\ncore.clearMap('hero');\ncore.setHeroLoc('x', (core.bigmap.width||15)-1-core.getHeroLoc('x'));\ncore.setHeroLoc('y', (core.bigmap.height||15)-1-core.getHeroLoc('y'));\ncore.drawHero();\ncore.drawTip(core.material.items[itemId].name + '使用成功');",
