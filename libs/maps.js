...
maps.prototype.initBlock = function (x, y, id, addInfo, eventFloor) {
    ...
    block.event.sprite = core.sprite.getSpriteObj(block.event.id); // todo: id->sprite
